"""
Validation_together: Detection validation (병렬 실행용)
/home/gpu-agx/zoo/script/Validation_together/run_detect_validation_together.py
- coco2017_val 데이터셋으로 detect 엔진 validation 수행
...
def validate_detect() -> Dict[str, Any]:
    """Detection validation: coco2017_val"""
    ...
    if official_map is not None:
        summary_text += f"    [공식 지표] mAP@[0.5:0.95]: {official_map:.4f}\n"
